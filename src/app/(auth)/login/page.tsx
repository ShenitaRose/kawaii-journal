  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4"
      ...
      >
        ...
        <p className="text-center text-sm mb-6" style={{ color: '#b89ab8' }}>Sign in to your kawaii journal</p>
        ...
        <p className="text-center mt-4 text-sm" style={{ color: '#b89ab8' }}>
          ...
          <Link href="/signup" className="font-bold" style={{ color: '#c96ca3' }}>Sign up ✨</Link>
        </p>
      </motion.div>
    </main>
  )
